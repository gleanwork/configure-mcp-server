...
(function (fixturify) {
    ...
    function readSync(dir, options, _relativeRoot) {
        ...
        var obj = {};
        var entriesOptions = __assign(__assign({}, options), { directories: !ignoreEmptyDirs });
        for (var _i = 0, _a = walk_sync_1.default.entries(dir, entriesOptions); _i < _a.length; _i++) {
            var entry = _a[_i];
    ...
    function writeSync(dir, obj) {
        ...
        for (var entry in obj) {
            if (obj.hasOwnProperty(entry)) {
                ...
                var fullPath = "".concat(dir, "/").concat(entry);
                var value = obj[entry];
                var stat = void 0;
                try {
                ...
                if (typeof value === 'string') {
                    ...
                    throw new Error("".concat(entry, " in ").concat(dir, " : Expected string or object, got ").concat(value));
                }
            }
        }
    }
...
function addFile(obj, path, content) {
    ...
    if (typeof file !== 'string') {
        throw new Error("invalid file path: '".concat(path, "'"));
    }
    ...
    for (var _i = 0, segments_1 = segments; _i < segments_1.length; _i++) {
        ...
        if (entry === undefined) {
            ...
            if (typeof entry === 'object' && entry !== null) {
                ...
                throw new Error("expected no existing directory entry for '".concat(path, "' but got '").concat(entry, "'"));
            }
        }
    }
    return obj;
