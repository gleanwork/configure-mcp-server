...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/types.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/protocol.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/client/index.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/auth.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/client/auth.js
...
async function discoverOAuthMetadata(authorizationServerUrl, opts) {
  let metadata = await _discoverOAuthMetadata(authorizationServerUrl, "/.well-known/oauth-authorization-server", opts);
  if (metadata === void 0) {
    ...
    metadata = await _discoverOAuthMetadata(authorizationServerUrlStr, ".well-known/openid-configuration", opts);
  }
  return metadata;
}
async function _discoverOAuthMetadata(authorizationServerUrl, wellKnownMetadataPath, opts) {
  var _a;
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/client/sse.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/client/streamableHttp.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@https+++pkg.pr.new+gleanwork+typescript-sdk+@modelcontextprotocol+sdk@acc52bd/node_modules/@modelcontextprotocol/sdk/dist/esm/server/auth/errors.js
...
function getConfigDir() {
  ...
  return path.join(baseConfigDir, `glean-connect-mcp-server-${version}`);
}
...
function mcpProxy({ transportToClient, transportToServer }) {
  ...
  transportToClient.onmessage = (_message) => {
    ...
    if (message.method === "initialize") {
      ...
      if (clientInfo) clientInfo.name = `${clientInfo.name} (via @gleanwork/connect-mcp-server ${version})`;
